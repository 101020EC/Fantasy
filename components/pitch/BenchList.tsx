...
export default function BenchList({ benchPlayers, onPlayerClick }: BenchListProps) {
  return (
    <div className="mt-4 p-4 rounded-2xl bg-gradient-to-b from-purple-100/90 to-purple-50 dark:from-[#180024]/90 dark:to-[#100017] border border-purple-200 dark:border-purple-800/60 shadow-lg transition-colors">
      <div className="flex items-center justify-between mb-3 px-2">
        <h3 className="text-xs sm:text-sm font-black uppercase tracking-wider text-purple-900 dark:text-purple-300 flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-amber-500"></span>
          ตัวสำรอง (Substitutes)
        </h3>
        <span className="text-[11px] text-gray-500 dark:text-gray-400">เรียงตามลำดับ 1 - 4</span>
      </div>
