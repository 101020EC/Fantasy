          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div className="relative">
              <input
                ...
                autoFocus
                required
                className="w-full pl-11 pr-4 py-3.5 bg-pastel-bg dark:bg-[#12151c] border border-black/5 dark:border-white/10 rounded-full text-[#111318] dark:text-white font-bold placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pastel-blue text-sm transition"
              />
